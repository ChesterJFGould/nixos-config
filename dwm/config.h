...
static const char *fonts[]          = { "Liberation Mono:pixelsize=14" };
...
ResourcePref resources[] = {
	...
	{ "norm_bg",    STRING,  &(norm_bd) },
	{ "inv_fg",         STRING,  &(inv_fg) },
	{ "inv_bg",         STRING,  &(inv_bg) },
	{ "inv_bd",     STRING,  &(inv_bd) },
	{ "sel_fg",         STRING,  &(sel_fg) },
	{ "sel_bg",         STRING,  &(sel_bg) },
	{ "sel_bd",     STRING,  &(sel_bd) },
};
